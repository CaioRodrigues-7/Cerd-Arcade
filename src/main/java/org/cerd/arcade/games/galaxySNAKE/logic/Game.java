package org.cerd.arcade.games.galaxySNAKE.logic;

import org.cerd.arcade.games.galaxySNAKE.ui.Assets;
import org.cerd.arcade.games.galaxySNAKE.ui.Sounds;
...
public class Game
{
    ...
    private void changeBackgroundImage()
    {
        ...
        {
            assets.setBackgroundImageGame(new ImageIcon("src/resource/img/back/Background_2.png").getImage());
        }
        else if(snake.getBody().size() >= 10)
        {
            assets.setBackgroundImageGame(new ImageIcon("src/resource/img/back/Background_3.png").getImage());
        }
        else if(snake.getBody().size() >= 25)
        {
            assets.setBackgroundImageGame(new ImageIcon("src/resource/img/back/Background_4.png").getImage());
        }
        else
        {
            assets.setBackgroundImageGame(new ImageIcon("src/resource/img/back/Background_7.png").getImage());
        }
    }
