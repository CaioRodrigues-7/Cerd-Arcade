...
public class Sounds
{
    ...
    public Sounds()
    {
        backgroundMusic("src/resource/sound/background_music#2.wav");
        explosionSound("src/resource/sound/explosion_sound.wav");
        boostSound("src/resource/sound/boost_sound.wav");
    }
